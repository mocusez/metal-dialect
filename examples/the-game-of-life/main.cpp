...
#ifdef printMatrix
  {
    ...
    builder.create<mlir::cf::BranchOp>(loc, external_condition);
    {
      ...
      builder.create<mlir::memref::StoreOp>(
          ...
          builder.create<mlir::arith::AddIOp>(
              loc, builder.create<mlir::memref::LoadOp>(loc, i, mlir::ValueRange{}),
              i32_1),
          i);
      auto value = builder.create<mlir::arith::CmpIOp>(
          loc, mlir::arith::CmpIPredicate::slt,
          builder.create<mlir::memref::LoadOp>(loc, i, mlir::ValueRange{}), i32_row);
    ...
    }
    {
      ...
      builder.create<mlir::memref::StoreOp>(
          loc,
          builder.create<mlir::arith::AddIOp>(
              loc, builder.create<mlir::memref::LoadOp>(loc, j, mlir::ValueRange{}),
              i32_1),
          j);
      auto value = builder.create<mlir::arith::CmpIOp>(
          loc, mlir::arith::CmpIPredicate::slt,
          builder.create<mlir::memref::LoadOp>(loc, j, mlir::ValueRange{}),
          i32_columns);
